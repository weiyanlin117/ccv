...
// Explicit instantiation for the template parameters used in CCV - per-block
template __global__ void qk_int_sv_f16_attn_kernel<64, 64, 16, 16, 128, DataType::kInt8, QuantGranularity::kPerBlock, QuantGranularity::kPerBlock,
...
// Explicit instantiation for head_dim=64 - per-block
template __global__ void qk_int_sv_f16_attn_kernel<64, 64, 16, 16, 64, DataType::kInt8, QuantGranularity::kPerBlock, QuantGranularity::kPerBlock,
    float, false, half, ComputeUnit::kTensorCore, MaskMode::kNone, false, false>(
    int8_t *__restrict__ Q, int8_t *__restrict__ K, half *__restrict__ V, half *__restrict__ O, float *__restrict__ Lse,
    float *__restrict__ Q_scale, float *__restrict__ K_scale, half *__restrict__ V_mean,
    const uint32_t qo_len, const uint32_t kv_len, const uint32_t num_kv_groups,
...
// NEW: Add per-warp Q, per-block K kernels (matches PyTorch per_warp_int8 approach)
template __global__ void qk_int_sv_f16_attn_kernel<64, 64, 16, 16, 128, DataType::kInt8, QuantGranularity::kPerWarp, QuantGranularity::kPerBlock,
    float, false, half, ComputeUnit::kTensorCore, MaskMode::kNone, false, false>(
    int8_t *__restrict__ Q, int8_t *__restrict__ K, half *__restrict__ V, half *__restrict__ O, float *__restrict__ Lse,
    float *__restrict__ Q_scale, float *__restrict__ K_scale, half *__restrict__ V_mean,
    const uint32_t qo_len, const uint32_t kv_len, const uint32_t num_kv_groups,
...
// NEW: Add per-warp Q, per-block K kernel for head_dim=64
template __global__ void qk_int_sv_f16_attn_kernel<64, 64, 16, 16, 64, DataType::kInt8, QuantGranularity::kPerWarp, QuantGranularity::kPerBlock,
    float, false, half, ComputeUnit::kTensorCore, MaskMode::kNone, false, false>(
    int8_t *__restrict__ Q, int8_t *__restrict__ K, half *__restrict__ V, half *__restrict__ O, float *__restrict__ Lse,
    float *__restrict__ Q_scale, float *__restrict__ K_scale, half *__restrict__ V_mean,
    const uint32_t qo_len, const uint32_t kv_len, const uint32_t num_kv_groups,
...
// NEW: Add PyTorch-compatible template instantiations <128, 64, 32, 16, ...>
// PyTorch per-warp Q, per-block K kernel for head_dim=128
template __global__ void qk_int_sv_f16_attn_kernel<128, 64, 32, 16, 128, DataType::kInt8, QuantGranularity::kPerWarp, QuantGranularity::kPerBlock,
    float, false, half, ComputeUnit::kTensorCore, MaskMode::kNone, false, false>(
    int8_t *__restrict__ Q, int8_t *__restrict__ K, half *__restrict__ V, half *__restrict__ O, float *__restrict__ Lse,
    float *__restrict__ Q_scale, float *__restrict__ K_scale, half *__restrict__ V_mean,
    const uint32_t qo_len, const uint32_t kv_len, const uint32_t num_kv_groups,
...
// PyTorch per-warp Q, per-block K kernel for head_dim=64  
template __global__ void qk_int_sv_f16_attn_kernel<128, 64, 32, 16, 64, DataType::kInt8, QuantGranularity::kPerWarp, QuantGranularity::kPerBlock,
    float, false, half, ComputeUnit::kTensorCore, MaskMode::kNone, false, false>(
    int8_t *__restrict__ Q, int8_t *__restrict__ K, half *__restrict__ V, half *__restrict__ O, float *__restrict__ Lse,
    float *__restrict__ Q_scale, float *__restrict__ K_scale, half *__restrict__ V_mean,
    const uint32_t qo_len, const uint32_t kv_len, const uint32_t num_kv_groups,
...
// MISSING: Add PyTorch's actual template instantiation with WARP_K=64
// PyTorch per-warp Q, per-block K kernel for head_dim=128 with WARP_K=64
